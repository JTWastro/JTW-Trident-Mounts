...
const char html_homeOffsetAxis1[] PROGMEM =
  "<input style='width:6em;' value='%d' type='number' name='hc1' min='-648000' max='648000'>&nbsp;" L_HOME_OFFSET_RANGE_AXIS1 "<br />\n";
const char html_homeOffsetAxis2[] PROGMEM =
  "<input style='width:6em;' value='%d' type='number' name='hc2' min='-648000' max='648000'>&nbsp;" L_HOME_OFFSET_RANGE_AXIS2 "<br /><br />\n";
