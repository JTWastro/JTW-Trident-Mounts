...
#define SERIAL_B_BAUD_DEFAULT      921600 //   9600, n. Baud rate as above. See (src/pinmaps/) for Serial port assignments.   Infreq
...
#define MOUNT_TYPE                    GEM //    GEM, GEM         German Equatorial Mount, etc. that need meridian flips.     <-Req'd
                                          ...
                                          //         FORK        Fork Mount without meridian flips
...
#define SLEW_RATE_BASE_DESIRED       3.75 //    1.0, n. Desired slew rate in deg/sec. Adjustable at run-time from            <-Req'd
