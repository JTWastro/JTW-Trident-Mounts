...
#define NV_WIPE                        ON //         OFF, Causes the defaults to be written back into NV (FLASH,EEPROM,etc.)  Infreq
...
#define MDNS_NAME          "OnStepXWired" //   "onstep",  mDNS device name.                                                   Adjust
